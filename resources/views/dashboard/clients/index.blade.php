...
<div class="page-head">
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <span class="active">  المشرفون  </span>
        </li>
    </ul>
    <!-- END PAGE BREADCRUMB -->
                    ...
                    <!-- Begin: life time stats -->
                            <div class="portlet light bordered portlet-fit portlet-datatable">
                                ...
                                <div class="table-toolbar pull-left">
                                            <div class="btn-group">
                                                <a data-toggle="modal" href="#add_user"  id="sample_editable_1_new" class="btn green"> أضف عميل جديد 
                                         ...
                                         <table class="table table-striped table-hover" id="sample_3">
                                             <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$client->email}}</td>
                                                    <td>{{$client->phone}}</td>
                                                    <td>{{$client->altPhone}}</td>
                                                    <td>{{$client->gender == '0' ? 'أنثى' : 'ذكر'}}</td>
                                                    <td class = "actions">
    ...
    <div class="modal fade" id="add_user" tabindex="-1" role="basic" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="portlet-body form">
              <form class="form-horizontal" id="user-form-add" role="form" method="POST" action="{{route('clients.store')}}">
                @csrf
