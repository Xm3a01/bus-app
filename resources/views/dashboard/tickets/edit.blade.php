...
@section('content')
 ...
 <div class="page-head">
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <span class="active">تعديل التذكره </span>
        </li>
    </ul>
    <!-- END PAGE BREADCRUMB -->
    ...
    <div class="portlet light bordered">
            <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark bold uppercase">تعديل التذكره</span>
                    </div>
                 </div>
             ...
             <form class="form-horizontal" id="user-form" role="form" method="POST" action="{{route('tickets.update' , $ticket->id)}}">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" placeholder="عدد ساعات الرحله  " name="hourNumber" value="{{$ticket->hourNumber}}">
                          </div>  
                    </div>
